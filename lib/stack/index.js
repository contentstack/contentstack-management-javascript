...
export function Stack (http, data) {
  ...
  if (data && data.stack && data.stack.api_key) {
     ...
     * @memberof Stack
     * @func update
     * @returns {Promise<Stack>} Promise for Stack instance
     * @example
     ...
     * @param {String|Object=} uidOrOptions The UID of the Global field or options object
     * @param {Object=} option Optional configuration object (e.g., { branch: 'branch_uid' })
     ...
     * @param {String} environmentUid The name or UID of the Environment you want to get details.
     ...
     * @param {String} branchUid - The UID of the branch
     * @returns {Branch} Instance of Branch.
     *
     * @example
     * import * as contentstack from '@contentstack/management'
     * const client = contentstack.client()
    ...
    /**
     * @description Branch corresponds to Stack branch.
     * @param {String} branchUid - The UID of the branch alias
     * @returns {BranchAlias} Instance of BranchAlias.
     *
     * @example
     * import * as contentstack from '@contentstack/management'
     * const client = contentstack.client()
     ...
     * @func users
     * @async
     * @returns {Promise<Array>} Promise for array of User instances
     * @example
     * import * as contentstack from '@contentstack/management'
     * const client = contentstack.client()
     *
     ...
     * @async
     * @param {Object<string, Array<string>>} data - Object containing userId as key and array of role UIDs as value.
     ...
     * @func settings
     * @async
     * @returns {Promise<Object>} Promise for configuration settings of stack.
     * @example
     * import * as contentstack from '@contentstack/management'
     * const client = contentstack.client()
     *
     ...
     * @param {Object} roles - The roles object mapping email addresses to role UIDs. Example: { "[email protected]": [ "role_uid" ] }
     * @returns {Promise<Object>} Response Object.
     *
     * @example
     * import * as contentstack from '@contentstack/management'
     ...
     * @param {String} logItemUid - The UID of the log item
     * @returns {AuditLog} Instance of AuditLog.
     *
     * @example
     * import * as contentstack from '@contentstack/management'
     * const client = contentstack.client()
    ...
    /**
     * @description The Query on Stack will allow you to fetch details of all or specific Stacks.
     * @memberof Stack
     * @func query
     * @param {Object} params - Query parameters
     * @prop {Boolean} params.include_collaborators - Set this parameter to 'true' to include the details of the stack collaborators.
     * @prop {Boolean} params.include_stack_variables - Set this to 'true' to display the stack variables. Stack variables are extra information about the stack, such as the description, format of date, format of time, and so on. Users can include or exclude stack variables in the response.
     * @prop {Boolean} params.include_discrete_variables - Set this to 'true' to view the access token of your stack.
     * @prop {Boolean} params.include_count - Set this to 'true' to include in the response the total count of the stacks owned by or shared with a user account.
