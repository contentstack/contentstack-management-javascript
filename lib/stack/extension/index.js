...
export function Extension (http, data = {}) {
  ...
  if (data.extension) {
     ...
     * @memberof Extension
     * @func update
     * @returns {Promise<Extension>} Promise for Extension instance.
     * @example
     ...
     * @func upload
     * @async
     * @param {Object} data - Extension data object.
    ...
    /**
     * @description The Query on Extension will allow you to fetch details of all or specific Extensions.
     * @memberof Extension
     * @func query
